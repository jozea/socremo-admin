...
export class CorporateTransactionsComponent implements OnInit {
  ...
  columnsToDisplay: string[] = ['position', 'name', 'provider', 'transactionId', 'reference', 'type', 'status', 'amount', 'state', 'charge', 'fees', 'accion', 'rubik', 'date', 'beneficiaryAccountNumber', 'balanceBefore', 'balanceAfter', 'message', 'serviceID', 'beneficiary', 'createdAt', 'updatedAt', 'isCredit'];// 'beneficiaryName', 'beneficiaryMobile',
  ...
  ngOnInit() {
    ...
    // if 
    // ('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoie1wibW9iaWxlTnVtYmVyXCI6XCIwODAzNTM2ODc3OFwiLFwicm9sZVwiOlwiZGV2ZWxvcGVyXCIsXCJfaWRcIjpcIjVmYmI3YWE3NDFlMjQ2MDRlZGIwZWQ3Y1wifSIsImlhdCI6MTYyNjY5OTgxNywiZXhwIjoxNjI2Nzg2MjE3fQ.bwSt8_pUuF-SkpJbxAXE2QcgCiW99_hvbuE-WpUh5QE' === 
    //  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoie1wibW9iaWxlTnVtYmVyXCI6XCIwODAzNTM2ODc3OFwiLFwicm9sZVwiOlwiZGV2ZWxvcGVyXCIsXCJfaWRcIjpcIjVmYmI3YWE3NDFlMjQ2MDRlZGIwZWQ3Y1wifSIsImlhdCI6MTYyNjY5OTgxNywiZXhwIjoxNjI2Nzg2MjE3fQ.bwSt8_pUuF-SkpJbxAXE2QcgCiW99_hvbuE-WpUh5QE') {
    //   console.log('yess')
    // }
  }
  ...
  fetchAllTransaction(
    ...
    this.corporateService.fetchTransactions(model)
