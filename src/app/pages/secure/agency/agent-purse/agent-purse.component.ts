...
@Component({
  selector: 'app-agent-purse',
  templateUrl: './agent-purse.component.html',
  styleUrls: ['./agent-purse.component.scss'],
  animations: [
...
export class AgentPurseComponent implements OnInit, AfterViewInit {


 
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  columnsToDisplay: string[] = ['position', 'agentID', 'businessName', 'agentName', 'balance', 'action', 'date'];
